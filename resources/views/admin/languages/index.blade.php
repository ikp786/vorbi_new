...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="javascript:;">Languages</a></li>
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">All Languages</li>
        </ol>
        <h6 class="font-weight-bolder mb-0">All Languages</h6>
    </nav>
@endsection
                    ...
                    <div class="d-lg-flex">
                        ...
                        <div class="ms-auto my-auto mt-lg-0 mt-4">
                            <div class="ms-auto my-auto">
                                <button type="button" class="btn bg-gradient-primary btn-sm mb-0 rowadd" data-bs-toggle="modal" data-bs-target="#modal-create">+&nbsp; New Language</button>
...
@section('script')
    ...
    <script>
        $(document).ready(function (){
            ...
            const addForm = '{{ route('admin.languages.store') }}';
