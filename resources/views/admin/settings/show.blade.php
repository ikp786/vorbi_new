                    ...
                    <div class="d-lg-flex">
                        ...
                        <div class="ms-auto my-auto mt-lg-0 mt-4">
                            <div class="ms-auto my-auto">
                                <a href="{{route('admin.settings.index')}}" class="btn bg-gradient-primary btn-sm mb-0">Back</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card-body px-0 pb-0">
                    {{--<div class="nav-wrapper position-relative end-0">
                        <ul class="nav nav-pills nav-fill p-1" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link mb-0 px-0 py-1" data-bs-toggle="tab" href="#dashboard-2-tabs-icons" role="tab" aria-controls="code" aria-selected="false">
                                    <i class="ni ni-laptop text-sm me-2"></i> Dashboard
                                </a>
                            </li>
                        </ul>
                    ...
                    <div class="mb-5">
                        <!--form panels-->
                        <div class="row">
                            <div class="col-12 col-lg-12 m-auto p-5">
                                <form class="" action="{{route('admin.settings.store')}}" method="POST">
                                @csrf
                                    <!--single form panel-->
                                    <div class="text-start">
                                        <input name="id" type="hidden" value="{{ $data->id }}"/>
                                        <label>Title</label>
                                        <input readonly name="title" class="form-control mb-3" value="{{ old('title') ?? $data->title }}" type="text"/>
                                        <label>Body</label>
                                        <textarea name="body" class="form-control mb-3" type="text" rows="4" id="ckeditor" required>
                                            {{ old('body') ?? $data->body }}
                                        </textarea>
                                    </div>
                                    <div class="button-row d-flex mt-4">
                                        <button class="btn bg-gradient-dark ms-auto mb-0 js-btn-next" type="submit">Update</button>
                                    </div>
                                </form>
                            </div>
                        </div>
