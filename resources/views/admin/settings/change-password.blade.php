...
<div class="row">
    ...
    <form action="{{ route('admin.change-password') }}" method="post" class="text-start">
        @csrf
        <div class="row">
            <div class="col-md-6">
        ...
        <label for="title">{{ __('New Password') }}</label>
        <div class="mb-3">
            <input type="password" name="new_password" class="form-control">
        </div>
        <div class="mb-3">
            <button class="btn" style="    background-color: #fd5a40;
            color: #fff;" type="submit">Submit</button>
        </div>
    </div>
    </div>
    </form>
